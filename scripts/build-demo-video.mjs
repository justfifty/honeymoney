...
const SHOTS = [
  ...
  { deck: 4, cap: "The 3-Bucket Method: Must-Paid · Savings · Privacy",
    vo: "One simple method. Must-paid for rent and bills, shared and visible. A savings percentage, moved before it can be spent. And a privacy bucket, personal by default." },
  ...
  { deck: 8, cap: "Sponsored seats · sponsored literacy · licensed opt-in referrals",
    vo: "The model is budgeting goals and insights, as a service. Employers sponsor seats like health cover; households never pay. Sponsored literacy and licensed, opt-in referrals come later — that switch is off in code today, because a fee tied to a score would corrupt the score." },
