# HoneyMoney — Privacy Notice / Notis Privasi

<!-- GENERATED FILE — DO NOT EDIT.
     Source: web/src/app/privacy/notice.ts
     Regenerate: npm run privacy:doc -->

**Version 2026-08-24** · Issued under the Personal Data Protection Act 2010 (Malaysia)

Live at https://honeymoney.app/privacy

> The Bahasa Malaysia text is a working translation and has not yet been
> certified by a Malaysian legal practitioner. See the note at the top of
> `web/src/app/privacy/notice.ts`.
...
- Basic visit counts: the page visited, the country it was viewed from, and how long it stayed open. No IP address is stored, no browser fingerprint, and views are not linked to your account.
...
- Kiraan lawatan asas: halaman yang dilawati, negara ia dilihat, dan berapa lama ia dibuka. Tiada alamat IP disimpan, tiada cap jari pelayar, dan lawatan tidak dikaitkan dengan akaun anda.
